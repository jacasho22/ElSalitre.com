...
// src/use-snapshot.ts
var { use } = import_react5.default;
var targetCache = /* @__PURE__ */ new WeakMap();
function useSnapshot(service, options) {
  const { actions, context, sync: notifyInSync } = options ?? {};
  const lastSnapshot = (0, import_react5.useRef)();
  const lastAffected = (0, import_react5.useRef)();
  const currSnapshot = (0, import_react5.useSyncExternalStore)(
    (0, import_react5.useCallback)((callback) => (0, import_store.subscribe)(service.state, callback, notifyInSync), [notifyInSync]),
    () => {
  ...
  const ctx = (0, import_react5.useMemo)(() => compact(context ?? {}), [context]);
  useUpdateEffect(() => {
  ...
  const proxyCache = (0, import_react5.useMemo)(() => /* @__PURE__ */ new WeakMap(), []);
